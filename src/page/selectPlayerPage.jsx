...
const SelectPlayerPage = () => {
  return (
    ...
    justify-center gap-[50px]'>
      <div className='flex itema-center justify-center gap-1'>
      ...
      <div className='bg-[#1a2a33] p-[]10px flex items-center justify-between rounded-[15px]'>
        <button className='w-[45%] p-[10px] bg-none border-none flex items-center justify-center cursor-pointer hover:bg[31f3641 hover:shadow-[0_5px_0_rgba(0,0,0,0.25)] rounded-[10px]'><img src={CrossIcongrey} alt="CrossIcongrey" /></button>
        <button className='w-[45%] p-[10px] bg-none border-none flex items-center justify-center cursor-pointer hover:bg[#1f3641 hover:shadow-[0_5px_0_rgba(0,0,0,0.25)] rounded-[10px]'><img src={CircleIcongrey} alt="CircleIcongrey" /></button>
      </div>
      <h3 className='text-[#a8bfc9] text-base font-semibold'>Remember: X goes first</h3>
      </section>
